				...
				<div class="col-md-6 col-sm-12">
					<form class="form" method="POST" action="">
						...
						<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="row">
									...
									<div class="col">
										<input type="date" name="fsd" class="form-control">
									</div>
								</div>
							</div>
							<div class="form-group">
						...
						<div class="row">
							...
							<div class="col">
										<input type="date" name="vd" class="form-control">
							</div>
						</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<input type="submit" name="pr" value="Register" class="btn btn-primary w-75" style="margin-left: 10%;">
						</div>
					</form>
				</div>
			</div>
